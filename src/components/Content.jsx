export default function Content(){
    return(
        <section id="Content" className="bg-secondary">
            <div className="text-4xl text-primary text-center mb-12">
                Daftar Rekanan
            </div>
            <div className="flex flex-col items-center justify-center font-mono space-y-8 px-4 md:grid md:grid-cols-4 md:gap-4 md:space-x-4">
